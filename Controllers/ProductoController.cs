...
public class ProductoController : ControllerBase
{
    ...
    {
        if (producto == null) return BadRequest(new ErrorResponse("El producto no puede ser nulo."));
        ...
        catch (Exception ex)
        {
            return StatusCode(500,
                new ErrorResponse("Hubo un problema al registrar el producto. Intente nuevamente.", ex.Message));
        }
    }
    ...
    {
        if (productoId <= 0) return BadRequest(new ErrorResponse("ID de producto inválido."));
        ...
        {
            return StatusCode(500,
                new ErrorResponse("Hubo un problema al editar el producto. Intente nuevamente.", ex.Message));
        }
    }
